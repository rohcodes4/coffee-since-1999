      ...
      <div className="relative h-[60vh] min-h-[440px] max-h-[640px]">
        ...
        <div className="absolute inset-0 flex flex-col justify-center px-6 lg:px-16 max-w-7xl mx-auto w-full">
          ...
          >
            ...
            <div className="inline-flex items-center gap-3 px-5 py-2.5 rounded-full border border-caramel/30 bg-caramel/10 backdrop-blur-sm">
              ...
              >
                ...
                <div className="relative aspect-[3/4] overflow-hidden">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-5">
                    ...
                    <p className="font-sans text-[11px] text-paper/60 leading-snug group-hover:text-paper/80 transition-colors duration-300">
                      {m.desc}
                    </p>
                  </div>
                </div>
